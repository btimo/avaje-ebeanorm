...
public interface SpiTransaction extends Transaction {
  ...
  /**
   * Register a "Derived Relationship" (that requires an additional updateAdd).
   */
  ...
  /**
   * Return the mode for Index updates for this transaction.
   * <p>
   *   This will most often be null but can be set on a transaction
