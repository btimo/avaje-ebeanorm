...
public class BaseIndexQueueReader {
  ...
  public boolean process() {
    ...
    for (Map.Entry<String, List<SqlRow>> queueEntries : map.entrySet()) {
      addEntries(indexUpdates, queueEntries);
    }
  ...
  private void addEntries(IndexUpdates indexUpdates, Map.Entry<String, List<SqlRow>> queueEntries) {
  ...
  private void addEntry(IndexUpdates indexUpdates, SqlRow entry) {
